...
namespace BL
{
    public class PlayerManager : CharacterManager
    {
        ...
        public override void OnNetworkSpawn()
        {
            ...
            if (IsOwner && !IsServer)
            {
                WorldSaveGameManager.instance.currentCharacterData.currentHealth = 200;
                WorldSaveGameManager.instance.currentCharacterData.endurance = 10;
                WorldSaveGameManager.instance.currentCharacterData.vitality = 15;
                WorldSaveGameManager.instance.currentCharacterData.currentStamina = 200;
                WorldSaveGameManager.instance.currentCharacterData.xPosition = -1.918454f;
                WorldSaveGameManager.instance.currentCharacterData.yPosition = -2.912645f;
                WorldSaveGameManager.instance.currentCharacterData.zPosition = 6.26545f;
        ...
        public void LoadGameDataFromCurrentCharacterData(ref CharacterSaveData currentCharacterData)
        {
            ...
            Debug.Log("guluhere");
            Debug.Log(playerNetworkManager.currentHealth.Value + "playerNetworkManager.currentHealth.Value");
        }
